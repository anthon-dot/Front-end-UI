...
.nav-list{display:grid;gap:8px;padding:16px 12px}.nav-item{border:0;background:transparent;color:#334155;text-align:left;padding:11px 12px;border-radius:8px;font-weight:700;cursor:pointer}.nav-item:hover,.nav-item.active{background:#eff6ff;color:#1d4ed8}.logout{margin-top:12px;color:#be123c}
